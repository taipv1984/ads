...
export const getColor = (c?: string, fallback: string = 'black') => c ? ((COLOR as any)[c] || c) : fallback;
...
export const AnimatedShapeElement = memo(({ shape, isFocused }: { shape: ShapeElement, isFocused: boolean }) => {
